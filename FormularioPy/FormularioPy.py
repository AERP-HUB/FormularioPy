...
def guardar_datos():
    ...
    #Obetener el genero seleccionado
    genero = ""
    if var_genero.get() == 1:
        genero = "Hombre"
    ...
    if (es_entero_valido(edad) and es_decimal_valido(estatura) and 
        ...
        #Crear uno cadena con los datos
        ...
        messagebox.showinfo("Informacion", "Daatos guardados con exito:\n\n" + datos)
...
label_apellidos = tk.Label(ventana, text = "Apelldios: ")
